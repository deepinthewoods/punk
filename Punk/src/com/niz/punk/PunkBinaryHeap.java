...
/** @author Nathan Sweet */
public class PunkBinaryHeap {
	public int size = 0;

	private Node[] nodes;
	private final boolean isMaxHeap;
	private IntMap<Node> map = new IntMap<Node>();
	public PunkBinaryHeap () {
		this(16, false);
	}

	public PunkBinaryHeap (int capacity, boolean isMaxHeap) {
	...
	public boolean contains(Node t){
		return map.containsKey(t.key());
	}
	public Node get(Node val){
		return map.get(val.key());
	}
	public void makePath(PunkBlockList list){
		//TODO trace parents back, eliminate runs
	}
	
	
	public Pool<Node> pool = new Pool<Node>(){
	...
	public class Node {
		...
		public boolean equals(Node loc){
