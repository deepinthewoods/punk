...
/** @author Nathan Sweet */
public class IntMappedHeap<T extends IntMappedHeap.Node> {
	IntMap<T> map = new IntMap<T>(200);
	public int size = 0;

	private Node[] nodes;
	private final boolean isMaxHeap;

	public IntMappedHeap () {
		this(16, false);
	}

	public IntMappedHeap (int capacity, boolean isMaxHeap) {
	...
	public boolean contains(T node){
		if (map.containsKey(node.key))return true;
		return false;
	}
